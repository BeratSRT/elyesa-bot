...
module.exports = message => {
  ...
  .setDescription(`Üzgünüm ancak komutları kullanamazsınız! Kurucularımız tarafından **${karalistesebep}** sebebiyle komutları kullanmanız yasaklandı!.`)
   .setFooter(`Elyesa'dan engellendiniz.`)
   ...
   client.channels.cache.get("921134084275716117").send(westrabencanımbro)
 ...
 client.channels.cache.get("921134084275716117").send(westrabencanımbrosadadsasd)
